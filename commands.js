const commands = [
  ...
  {
    name: 'sondage',
    description: '📊 Crée un sondage avec réponses prédéfinies (Admin/Modo)',
    options: [
      { name: 'question', type: 3, description: 'La question posée dans le sondage', required: true },
      { name: 'reponse_1', type: 3, description: 'Première réponse', required: true },
      { name: 'reponse_2', type: 3, description: 'Deuxième réponse', required: true },
      { name: 'reponse_3', type: 3, description: 'Troisième réponse', required: false },
      { name: 'reponse_4', type: 3, description: 'Quatrième réponse', required: false },
      { name: 'reponse_5', type: 3, description: 'Cinquième réponse', required: false },
      { name: 'reponse_6', type: 3, description: 'Sixième réponse', required: false },
      { name: 'reponse_7', type: 3, description: 'Septième réponse', required: false },
      { name: 'reponse_8', type: 3, description: 'Huitième réponse', required: false },
      { name: 'reponse_9', type: 3, description: 'Neuvième réponse', required: false },
      { name: 'reponse_10', type: 3, description: 'Dixième réponse', required: false },
      { name: 'choix_multiple', type: 5, description: 'Autoriser plusieurs réponses par joueur', required: false },
      { name: 'anonyme', type: 5, description: 'Masquer le nom des votants', required: false },
      { name: 'ping_everyone', type: 5, description: 'Mentionner @everyone une seule fois à la publication', required: false },
      {
        name: 'duree',
        type: 3,
        description: 'Durée avant fermeture automatique (sans limite par défaut)',
        required: false,
        choices: [
          ...
          { name: 'Sans limite', value: 'unlimited' },
        ],
      },
      { name: 'image', type: 11, description: 'Image facultative à afficher avec le sondage', required: false },
    ],
  },
  {
